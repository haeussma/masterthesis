...
After all models are fitted, an overview table is printed which lists all the kinetic parameters of each model together with the respective 1σ standard deviation in percent. The table is sorted by ascending AIC.
